...
export default function CrearMedico({ navigation }) {
  ...
  const handleCrear = () => {
    if (especialidad_id && nombre && edad && documento && telefono) {
      alert("✅ Medico creada (simulado)");
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Agendar Nuevo Medico</Text>
        <TextInput
            style={styles.input}
            placeholder="Especialidad ID"
