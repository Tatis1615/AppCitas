    ...
    <View style={styles.container}>
      ...
      <View style={styles.topButtons}>
        <TouchableOpacity
          style={[
            styles.topButton,
            { backgroundColor: isMedico ? "#aaa" : "#f58eb0ff" },
          ]}
          disabled={isMedico}
          onPress={async () => {
            const medico_id = await AsyncStorage.getItem("medico_id");
            console.log("👨‍⚕️ medico_id enviado:", medico_id);
            navigation.navigate("CrearCitaMedico", { medico_id });
          }}
        >
